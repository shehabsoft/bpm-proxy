package com.emu.bpm.proxy.repository;

import com.emu.bpm.proxy.BpmProxyApp;

import com.emu.bpm.proxy.config.Constants;
import com.emu.bpm.proxy.config.TestSecurityConfiguration;
import com.emu.bpm.proxy.config.audit.AuditEventConverter;
import com.emu.bpm.proxy.domain.PersistentAuditEvent;
...
import static com.emu.bpm.proxy.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;

/**
 * Integration tests for {@link CustomAuditEventRepository}.
 */
@SpringBootTest(classes = {BpmProxyApp.class, TestSecurityConfiguration.class})
@Transactional
