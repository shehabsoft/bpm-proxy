...
import com.emu.bpm.proxy.config.KafkaProperties;
...
@RestController
@RequestMapping("/api/bpm-proxy-kafka")
public class BpmProxyKafkaResource {

    private final Logger log = LoggerFactory.getLogger(BpmProxyKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public BpmProxyKafkaResource(KafkaProperties kafkaProperties) {
